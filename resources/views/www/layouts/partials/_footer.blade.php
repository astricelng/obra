<footer class="">
    ...
    <div id="nav-controls">
        <ul class="footer__menu menu">
            ...
            <li><a class="menu-slider" href="#">home</a></li>
            <li><a class="menu-slider" href="#">menu</a></li>
            <li><a class="menu-slider" href="#">food</a></li>
            <li><a class="menu-slider" href="#">about</a></li>
            <li><a class="menu-slider" href="#">work with us</a></li>
